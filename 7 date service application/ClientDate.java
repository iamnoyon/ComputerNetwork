...
public class ClientDate extends JFrame
{
	...
	ClientDate(){
     ...
     // Button Part
       ...
       //Font     f = new Font("Courier", Font.BOLD, 10);
  	  ...
  	  getYear.setBackground(Color.YELLOW);  
  	     Clear = new JButton("Clear");	
  	     	Clear.setBackground(Color.RED);
  	   Connect = new JButton("Connect");
  	  Connect.setBackground(Color.CYAN);
      ...
      //  System.out.println("Started client to port " + port);
        ...
        {    	
        ...
        catch(IOException ioEx)
         {
           ...
           JOptionPane.showMessageDialog(ClientDate.this,String.format("%s",res));
         }		
   ...
   public class disconnectButtonHandler implements ActionListener
   {
  	  public void actionPerformed(ActionEvent event)
  	  {
  	    ...
  	    if(str.equals("Disconnected from Server"))
  	     {
  	      JOptionPane.showMessageDialog(ClientDate.this,String.format("%s",str)); 	
  	     }	
  	    }
  	    catch(Exception e)
  	    {
