...
public class ClientDate2 extends JFrame
{
	...
	ClientDate2(){
     ...
     // Button Part
       ...
       //Font     f = new Font("Courier", Font.BOLD, 10);
  	    ...
  	    getDay.setBackground(Color.green);
  	   getMonth= new JButton("Month");
  	   getMonth.setBackground(Color.GREEN);
  	    getYear= new JButton("Year");
  	  getYear.setBackground(Color.GREEN);  
  	...
  	disconnect.setBackground(Color.GREEN);
      ...
      //  System.out.println("Started client to port " + port);
        ...
        {    	
        ...
        catch(IOException ioEx)
         {
           ...
           JOptionPane.showMessageDialog(ClientDate2.this,String.format("%s",res));
         }		
   ...
   public class disconnectButtonHandler implements ActionListener
   {
  	  public void actionPerformed(ActionEvent event)
  	  {
  	    ...
  	    if(str.equals("Disconnected from Server"))
  	     {
  	      JOptionPane.showMessageDialog(ClientDate2.this,String.format("%s",str)); 	
  	     }	
  	    }
  	    catch(Exception e)
  	    {
